...
declare global {
    ...
    interface Attribute extends Roll20Object {
        get(property: 'id'): string;
        get(property: 'name'): string;
        get(property: 'current'): string | number;
        get(property: 'max'): string | number;
        get(property: '_characterid'): string;
        get(property: string): any;
    }
    ...
    interface ProximityTriggerState {
        ...
        buttonCallbacks?: Record<string, ButtonCallbackData>;
    }

    /**
     * Button Callback Data (for state persistence)
     */
    ...
    type Roll20Graphic = Graphic;
    type Roll20Character = Character;
    type Roll20Attribute = Attribute;
    type Roll20Page = Page;
    type Roll20ChatMessage = ChatMessage;
}
